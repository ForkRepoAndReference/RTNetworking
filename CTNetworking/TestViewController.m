...
- (NSArray*)dataSource
{
    if (_dataSource == nil) {
        _dataSource = @[
            ...
            @{
                kBSDataSourceItemKeyTestCaseType : @(TestCaseTypeZhihuLatestAPI),
                kBSDataSourceItemKeyTestCaseTitle : @"知乎最新"
            },
            @{
                kBSDataSourceItemKeyTestCaseType : @(TestCaseTypeZhihuDetailAPI),
                kBSDataSourceItemKeyTestCaseTitle : @"知乎详细"
            },
            @{
                kBSDataSourceItemKeyTestCaseType : @(TestCaseTypeGithubSearchUsersAPI),
                kBSDataSourceItemKeyTestCaseTitle : @"Github查找用户"
            }
        ];
    }
    return _dataSource;
